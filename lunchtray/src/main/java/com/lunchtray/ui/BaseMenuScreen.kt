...
import com.lunchtray.R

@Composable
fun BaseMenuScreen(
    options: List<com.lunchtray.model.MenuItem>,
    modifier: Modifier = Modifier,
    onCancelButtonClicked: () -> Unit = {},
    onNextButtonClicked: () -> Unit = {},
    onSelectionChanged: (com.lunchtray.model.MenuItem) -> Unit,
) {
...
@Composable
fun MenuItemRow(
    item: com.lunchtray.model.MenuItem,
