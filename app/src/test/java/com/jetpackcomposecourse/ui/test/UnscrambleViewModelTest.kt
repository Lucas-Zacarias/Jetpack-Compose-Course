package com.jetpackcomposecourse.ui.test

import com.jetpackcomposecourse.data.MAX_NO_OF_WORDS
import com.jetpackcomposecourse.data.SCORE_INCREASE
import com.jetpackcomposecourse.data.getUnscrambledWord
import com.jetpackcomposecourse.ui.practice.UnscrambleViewModel
...
class UnscrambleViewModelTest {
    ...
    fun unscrambleViewModel_CorrectWordGuessed_ScoreUpdatedAndErrorFlagUnset() {
        ...
        val correctPlayerWord = getUnscrambledWord(currentUnscrambleUiState.currentScrambleWord)
