...
android {
    namespace = "com.juicetraker"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.juicetraker"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.lifecycle:lifecycle-livedata-core-ktx:${rootProject.extra["lifecycle_version"]}")
