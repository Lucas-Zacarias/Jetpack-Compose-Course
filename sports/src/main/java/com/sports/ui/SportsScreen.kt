...
import com.sports.R
import com.sports.ui.theme.SportsTheme
import com.sports.ui.utils.SportsContentType
...
private fun SportsListItem(
    sport: com.sports.model.Sport,
    onItemClick: (com.sports.model.Sport) -> Unit,
    modifier: Modifier = Modifier
) {
    Card(
...
@Composable
private fun SportsListImageItem(sport: com.sports.model.Sport, modifier: Modifier = Modifier) {
    Box(
        modifier = modifier
    ) {
        Image(
...
private fun SportsList(
    sports: List<com.sports.model.Sport>,
    onClick: (com.sports.model.Sport) -> Unit,
    modifier: Modifier = Modifier,
...
private fun SportsDetail(
    selectedSport: com.sports.model.Sport,
    onBackPressed: () -> Unit,
...
private fun SportsListAndDetails(
    currentSport: com.sports.model.Sport,
    sports: List<com.sports.model.Sport>,
    onClick: (com.sports.model.Sport) -> Unit,
    modifier: Modifier = Modifier,
    contentPadding: PaddingValues = PaddingValues(0.dp)
...
fun SportsListItemPreview() {
    SportsTheme {
        SportsListItem(
            sport = com.sports.data.LocalSportsDataProvider.defaultSport,
            onItemClick = {}
        )
    }
}
...
fun SportsListPreview() {
    SportsTheme {
        Surface {
            SportsList(
                sports = com.sports.data.LocalSportsDataProvider.getSportsData(),
                onClick = {},
            )
        }
    }
