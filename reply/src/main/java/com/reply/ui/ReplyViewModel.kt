...
import com.reply.data.LocalEmailsDataProvider
...
class ReplyViewModel : ViewModel() {
    ...
    private fun initializeUIState() {
        val mailboxes: Map<MailboxType, List<com.reply.model.Email>> =
    ...
    fun updateDetailsScreenStates(email: com.reply.model.Email) {
        _uiState.update {
            it.copy(
