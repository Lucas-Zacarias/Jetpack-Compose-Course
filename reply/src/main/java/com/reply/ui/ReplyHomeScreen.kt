...
import com.reply.R
import com.reply.data.LocalAccountsDataProvider
import com.reply.model.Email
import com.reply.model.MailboxType
import com.reply.ui.util.ReplyContentType
import com.reply.ui.util.ReplyNavigationType
        ...
        PermanentNavigationDrawer(
            drawerContent = {
                PermanentDrawerSheet(Modifier.width(dimensionResource(id = R.dimen.drawer_width))) {
                    val permanentNavigationDrawerContentDescription = stringResource(id = R.string.navigation_drawer)
                    NavigationDrawerContent(
                        ...
                        modifier = Modifier
                            ...
                            .testTag(permanentNavigationDrawerContentDescription)
                    )
                }
            }
        ) {
