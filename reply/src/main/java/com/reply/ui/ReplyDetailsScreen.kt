...
private fun ReplyEmailDetailsCard(
    email: com.reply.model.Email,
    mailboxType: com.reply.model.MailboxType,
    modifier: Modifier = Modifier,
    isFullScreen: Boolean = false
) {
...
private fun DetailsScreenButtonBar(
    ...
    Box(modifier = modifier) {
        when (mailboxType) {
            ...
            com.reply.model.MailboxType.Sent, com.reply.model.MailboxType.Inbox ->
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(
...
@Composable
private fun DetailsScreenHeader(email: com.reply.model.Email, modifier: Modifier = Modifier) {
